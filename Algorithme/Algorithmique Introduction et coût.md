...
​	Définition : Soit n la taille d'une donnée, si le nombre d'opérations à effectuer dans le pire 	des cas est de la forme $ a\timesn+b $ où a et b sont des nombres réels, , on dit que la 	complexité de cet algorithme est linéaire. 
