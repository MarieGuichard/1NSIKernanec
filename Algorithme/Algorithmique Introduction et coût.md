...
​Définition : Soit n la taille d'une donnée, si le nombre d'opérations à effectuer dans le pire 	des cas est de la forme  $an^{2}+bn+c$ où a, b et c sont des nombres réels, , on dit que la 	complexité de cet algorithme est quadratique. 
